---
layout: lesson
title: 'I.7 · Compositional Sources and References in Fashion Design'
title_es: 'I.7 · Fuentes y referencias compositivas en el diseño de moda'
slug: i-7-referencias-moda
date: 2026-08-20
author: 'Rubén Vega Balbás, PhD'
lang: en
permalink: /lessons/en/digital-creativity-i/i-7-fashion-references/
...
**CONTENIDOS anchor (verbatim, official guía):** *Fuentes y referencias compositivas en el diseño de moda.*

**Competencies served:** `CON1`, `HAB9`, `COMP8`, `COMP9` — `COMP9` (original problem-solving from known concepts) is the load-bearing one here: sourcing well is itself an original act, not a shortcut around one.

**Learning outcomes:** none of the guía's six `learning_outcomes` bullets names compositional-reference-sourcing directly — stated honestly, as with I.1, rather than forcing a fit.
...
- **Build a small compositional-reference board** with attribution and a reflection note.
- **Distinguish "a reference that informs" from "a reference that is copied."**
...
Whose context, agency, and right not to be reused are missing when a source becomes a moodboard tile? Name one pattern your own sourcing surfaced before you chose anything — Campinho's finding makes that audit unavoidable once you know to look.

### The debate prompt

**If a mood-board search reproduces a biased pattern before you've chosen anything, whose responsibility is the bias — the search engine's, the archive's, or the student's for not noticing?** No source in this unit settles it; naming Campinho's finding is that the question becomes unavoidable once you know to look for it.

<figure class="lesson-media lesson-media--placeholder" data-media-slot="I.7.video.reference-process" markdown="0">
<img src="{{ '/assets/images/lesson-covers/dc-i-07-situated-reference-semantic.svg' | relative_url }}" width="1600" height="560" alt="Abstract placeholder for a reference research process demonstration; no people or garments depicted." loading="lazy" />
<figcaption>
<p><strong>Why this is here:</strong> A short archive or research clip pauses when a source becomes a design move.</p>
<p><strong>Look for:</strong> Source, licence, visual property, and intended transformation.</p>
...
<img src="{{ '/assets/images/lesson-covers/dc-i-07-situated-reference-semantic.svg' | relative_url }}" width="1600" height="560" alt="Abstract placeholder for credited reference board and untraceable counterexample; no people or garments depicted." loading="lazy" />
<figcaption>
<p><strong>Why this is here:</strong> Paired boards test traceability, diversity, and compositional usefulness.</p>
<p><strong>Look for:</strong> Credit versus decorative collage.</p>
<p class="media-note">Placeholder visual — licensed media pending review.</p>
</figcaption>
</figure>

<figure class="lesson-media lesson-media--placeholder" data-media-slot="I.7.graphic.source-transform" markdown="0">
<img src="{{ '/assets/images/lesson-covers/dc-i-07-situated-reference-semantic.svg' | relative_url }}" width="1600" height="560" alt="Abstract diagram placeholder for source-visual property-transformation-composition-credit chain; no people or garments depicted." loading="lazy" />
<figcaption>
<p><strong>Why this is here:</strong> Maps source → visual property → transformation → new composition → credit.</p>
<p><strong>Look for:</strong> Where lineage is lost between steps.</p>
<p class="media-note">Placeholder visual — licensed media pending review.</p>
</figcaption>
</figure>
...
3. Distinguish "a reference that informs" from "a reference that is copied" — the sourcing-vs-plagiarism line `COMP9` requires.
