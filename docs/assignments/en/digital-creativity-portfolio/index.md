...
# Final Digital Portfolio Notebook
...
The portfolio may curate and sequence evidence, but it must not erase the productive middle: failed attempts, abandoned routes, feedback, and revisions are part of the assessment.

## The day-by-day Lab habit

Start the portfolio in the first class and update it every time Lab begins. A complete entry can be concise; it must be specific and navigable.

| Moment       | What to publish or archive                                          | Minimum evidence                                                |
| ------------ | ------------------------------------------------------------------- | --------------------------------------------------------------- |
| **Opening**  | Date, exercise title, brief, medium, constraint, and intention      | 3–5 lines or a marked-up brief                                  |
| **Making**   | Sketches, source images, files, tests, versions, or screen captures | At least two traces, including one imperfect or discarded route |
| **Exchange** | Peer/professor observation or your own critical question            | One comment and your response                                   |
...
Submit the URL or digital package through the Campus Virtual in the format and date announced there. Test the submission from a clean browser or device before handing it in. Be ready to open any process trace and explain one decision that changed the direction of a piece.

## References and course grounding

The brief is anchored in the official Digital Creativity I and II guides' contents, competencies, learning outcomes, formative activities, and evaluation categories. The reflective structure is informed by research on e-portfolios as authentic assessment; that research provides a design frame for making reflection inspectable, not a guarantee that one platform or interface produces better learning.

## References

- Zainuddin, Zamzami, Madziatul Churiyah, Wening Patmi Rahayu, Heri Pratikto, and Siti Hajar Halili. 2026. “E-Portfolios as Authentic Assessment in Pre-Service Teacher Education: Enhancing Reflection, Professional Identity, and Digital Preparedness.” _Education and Information Technologies_. https://doi.org/10.1007/s10639-025-13869-y.
