...
**Draft — all nine units now have first-pass lesson content, for the first time in this cascade.** Contact hours in `tracks.yml` close to **80/80 h** across the full CD I unit set. This is an honest hour-accounting fact, not a claim that the course is pedagogically complete or teachable end-to-end — most units declare a real evidence gap, stated on their own pages.
...
Institutional contract: official PDF [9729001103](https://universidadeuropea.es/myfiles/pr/9729001103.pdf) (2026-27), cloned at `digital-creativity-pedagogy/cv/guides/1-creacion-digital-i.json` (not published on Pages). Presencial formative load **150 h** (clases magistrales 10 · seminarios 20 · resolución 8 · investigaciones y proyectos 20 · talleres 14 · autónomo 56 · debates 8 · tutoría 12 · pruebas 2). Session timetable not yet allocated.
